...
class ToggleMousePointer {

  ToggleMousePointer() { }
  ToggleMousePointer(ToggleMousePointer const&) = delete;
  void operator=(ToggleMousePointer const&) = delete;

public:

  ~ToggleMousePointer() { }
  
  static ToggleMousePointer &getMousePointer() {
    static ToggleMousePointer pointer;
    return pointer;
  }
...
int main()
{
  ...
  ToggleMousePointer *mousePointer = &ToggleMousePointer::getMousePointer();
  ...
  if (choice == 1)
    mousePointer->GetAndSetMousePointer();
  else if (choice == 2)
    mousePointer->SetMousePointer();

  mousePointer->SetCursorPosition();
